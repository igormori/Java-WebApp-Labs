...
* Date: 10/28/2018
* Description: < This Servlet shows the login page with captcha and with the response from the Authenticate to display the right message for the user if there is
