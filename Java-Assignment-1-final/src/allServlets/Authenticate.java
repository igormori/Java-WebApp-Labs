...
* Date: 10/28/2018
* Description: <This Servlet will authenticate the users login, it will decrypt the password for clients and check the password for the admin users.
* 				Also it will redirect to the Login page with the right message for each validations>
*********************************************************************************/
