...
* Date: 10/28/2018
* Description: <This Servlet will display the Htmls from the HtmlEls.java class also the TAB2 contents >
*********************************************************************************/
package allServlets;
...
public class Tab2 extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String header=htm.header("Welcome, "+sessionname, "Logout","Tab2");
		...
		if(sessionname!=null)
		{
			pw.println(header+
					...
					"<div class=\"col-xs-12 col-md-12\"><h1 class=\"text-center\" >Tab2</h1></div>\n" + 
					"</div>"+
