...
* Date: 10/28/2018
* Description: <This Servlet will check all fields from the registration servlet and response the right message back. Also it will open the data base
* 				and insert the user registration into the data base >
*********************************************************************************/
					        ...
					        while(res.next())
					         {
							  ...
							  String sql = "insert into USERS (firstname,lastname,email,role,username, address, password,salt) "
							      ...
							      helperClasses.EmailSender.sendEmail("noreply@noreply.com",newUserObject.getEmail() , myHash, newUserObject.getEmail());
